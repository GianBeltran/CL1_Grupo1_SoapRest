package pe.edu.cibertec.cl1appsoap.endpoint;
...
import pe.edu.cibertec.cl1appsoap.converter.PacienteConvert;
...
public class PacienteEndPoint {
    ...
    @ResponsePayload
    public GetPacienteResponse getPacienteID(@RequestPayload GetPacienteRequest request){
        GetPacienteResponse response = new GetPacienteResponse();
        Pacientews pacientews = pacienteConvert.convertPacienteToPacienteWs(pacienteRepository.findById(request.getId()).get());
    ...
    public PostPacienteResponse postPaciente(@RequestPayload PostPacienteRequest request){
        ...
        Paciente newPaciente = pacienteConvert.convertPacienteWsToPaciente(request.getPaciente());
        Pacientews newPacientews = pacienteConvert.convertPacienteToPacienteWs(pacienteRepository.save(newPaciente));
